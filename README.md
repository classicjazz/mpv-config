...
My mpv.conf is tailored for rendering on current Macs such as the Mac Studio, Mac Mini, Macbooks and iMacs including using vo_gpu_next, libplacebo, Vulkan & MoltenVK for enhanced performance, as contrasted with legacy OpenGL rendering.
